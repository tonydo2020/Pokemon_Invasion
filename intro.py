...
# the front page with 2 click buttons, one to start the game, one to go to the high scores
class Button:
...
class EnemyDisplay:
    ...
    def __init__(self, ai_settings, screen, y_start):
        ...
        self.aliens = []
        images = [
            image.load('images/alien1_1.bmp'),
            image.load('images/alien2_1.bmp'),
            image.load('images/alien3_1.bmp'),
            image.load('images/ufo.bmp')
        ]
        for img in images:
    ...
    def show_examples(self):
        # display the aliens and the scores
