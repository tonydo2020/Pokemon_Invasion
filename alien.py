...
class Alien(pygame.sprite.Sprite):
    def __init__(self, ai_settings, screen, alien_type=3):
        ...
        # sound
        self.death_sound = pygame.mixer.Sound('alien_death.wav')
        self.fire_sound = pygame.mixer.Sound('alien_shoot.wav')
    ...
    def check_edges(self):
        # checks if the alien touches the screen
    ...
    def begin_death(self):
        # begins death animation for the alien
        self.dead = True
        self.death_index = 0
