...
# file that holds the assets for the random UFO that flies across the screen
class Ufo(pygame.sprite.Sprite):
    ...
    def __init__(self, ai_settings, screen, sound=True):
        ...
        self.death_frames.append(pygame.image.load('images/ufo-death.bmp'))
    ...
    def get_score(self):
        # random score for hitting the UFO
